    ...
    <aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
      <div class="container">
        ...
        <a href="{{ url(config('purdia.path')) }}" class="navbar-brand navbar-brand-autodark">
          <img src="{{ asset('vendor/purdia/static/logo-white.svg') }}" alt="Tabler" class="navbar-brand-image">
        </a>
          ...
          <ul class="navbar-nav pt-lg-3">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                @foreach( Purdia::getResources() as $resource)
                <li >
                  <a class="dropdown-item" href="{{ url(config('purdia.path').'/'.$resource) }}" >
                    {{ Str::title(str_replace('_', ' ', Str::singular( $resource ))) }}
                  </a>
                </li>
                @endforeach
              </ul>
